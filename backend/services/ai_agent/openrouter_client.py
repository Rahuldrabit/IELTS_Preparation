"""
OpenRouter Client — cloud LLM provider with access to many models.
...
class OpenRouterClient:
    ...
    def generate_structured(
        ...
        try:
            ...
            raise OpenRouterClientError(f"OpenRouter output not valid JSON: {e}")
        except Exception as e:
            raise OpenRouterClientError(f"OpenRouter call failed: {e}")
    ...
    def generate_text(
        ...
        try:
            ...
            raise OpenRouterClientError(f"OpenRouter text generation failed: {e}")
